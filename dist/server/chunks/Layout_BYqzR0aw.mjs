...
function DashboardLayout({ active, children, wallet }) {
  ...
  return /* @__PURE__ */ jsxs("div", { class: "flex h-screen overflow-hidden bg-void-900", children: [
    /* @__PURE__ */ jsxs("aside", { class: `flex flex-col border-r border-void-700 bg-void-850 shrink-0 transition-all duration-200 ${collapsed ? "w-14" : "w-52"}`, children: [
      ...
      /* @__PURE__ */ jsxs("nav", { class: "flex-1 py-3 px-2 space-y-0.5", children: [
        NAV.map((item) => {
    ...
    /* @__PURE__ */ jsx("div", { class: "flex-1 flex flex-col min-w-0 overflow-hidden", children })
  ] });
}
